...
// CONSTRUCTOR
Mesh::Mesh(TextureManager* tManager, GLSLProgram* shaders)
{
	LoadMeshFromFile("object.s3d");
...
{
	angle += seconds * 2;	// update the mesh's angle

	// create a normalized vec3 for rotating our cube
	glm::vec3 v = vec3(0.25f, 0.42f, 0.33f);
	v = glm::normalize(v);
